...
Shader "grass"
{
	Properties
	{
		...
		_noiseDist("noiseDist", 2D) = "white" {}
		_grad("grad", 2D) = "white" {}
		_scale_grad("scale_grad", Range( 0 , 1)) = 0.2
		_smooth("smooth", Range( 0 , 1)) = 1
		_Scalenoise("Scalenoise", Range( 0 , 1)) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime19 = _TimeParameters.x * 0.2;
				float cos18 = cos( mulTime19 );
				float sin18 = sin( mulTime19 );
				float2 rotator18 = mul( texCoord13 - float2( 0,0 ) , float2x2( cos18 , -sin18 , sin18 , cos18 )) + float2( 0,0 );
				float3 temp_cast_0 = (( ( tex2Dlod( _noiseDist, float4( rotator18, 0, 0.0) ).r * _Scalenoise ) * ( tex2Dlod( _grad, float4( texCoord13, 0, 0.0) ).r * _scale_grad ) )).xxx;
						 ...
						 ) : SV_Target
			{
				...
				float4 color15 = IsGammaSpace() ? float4(0.09714311,0.3490566,0.2055243,0) : float4(0.009585166,0.09992068,0.03485217,0);
				

				float3 BaseColor = color15.rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord13 = v.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float mulTime19 = _TimeParameters.x * 0.2;
				float cos18 = cos( mulTime19 );
				float sin18 = sin( mulTime19 );
				float2 rotator18 = mul( texCoord13 - float2( 0,0 ) , float2x2( cos18 , -sin18 , sin18 , cos18 )) + float2( 0,0 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1616,0;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;19;-1472,-240;Inherit;False;1;0;FLOAT;0.2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;18;-1280,-112;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;14;-1152,224;Inherit;True;Property;_grad;grad;2;0;Create;True;0;0;0;False;0;False;-1;fadfac55b75d2b146aec76c577b0e5f4;041d035ad852bad45bd09000428d7e7e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-1056,-32;Inherit;True;Property;_noiseDist;noiseDist;0;0;Create;True;0;0;0;False;0;False;-1;041d035ad852bad45bd09000428d7e7e;041d035ad852bad45bd09000428d7e7e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-896,160;Inherit;False;Property;_Scalenoise;Scalenoise;5;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-960,464;Inherit;False;Property;_scale_grad;scale_grad;3;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-704,336;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-480,208;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GradientNode;12;-512,432;Inherit;False;0;2;2;1,1,1,0;1,1,1,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-160,240;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-544,-208;Inherit;True;Property;_normal;normal;1;0;Create;True;0;0;0;False;0;False;-1;None;041d035ad852bad45bd09000428d7e7e;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;15;-1040,-464;Inherit;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.09714311,0.3490566,0.2055243,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;24;-216.7552,145.6152;Inherit;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-432,48;Inherit;False;Property;_smooth;smooth;4;0;Create;True;0;0;0;False;0;False;1;0.2;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=518E21AD5CF003F0722EB8BADBC46962B1122D03