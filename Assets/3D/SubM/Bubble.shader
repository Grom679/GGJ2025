...
Shader "Bubble"
{
	Properties
	{
		...
		_Multicolor("Multicolor", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Multicolor = IN.ase_texcoord8.xy * _Multicolor_ST.xy + _Multicolor_ST.zw;
				float4 tex2DNode14 = tex2D( _Multicolor, uv_Multicolor );
				

				float3 BaseColor = ( fresnelNode10 * tex2DNode14 ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = ( ( 1.0 * tex2DNode14 ) * 1.5 ).r;
				float Occlusion = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNode10 = ( _Bias + _Scale * pow( 1.0 - fresnelNdotV10, _Power ) );
				float2 uv_Multicolor = IN.ase_texcoord5.xy * _Multicolor_ST.xy + _Multicolor_ST.zw;
				float4 tex2DNode14 = tex2D( _Multicolor, uv_Multicolor );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNdotV10 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode10 = ( _Bias + _Scale * pow( 1.0 - fresnelNdotV10, _Power ) );
				float2 uv_Multicolor = IN.ase_texcoord3.xy * _Multicolor_ST.xy + _Multicolor_ST.zw;
				float4 tex2DNode14 = tex2D( _Multicolor, uv_Multicolor );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.ColorNode;11;-656,-288;Inherit;False;Property;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;10;-960,-112;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;14.54;False;3;FLOAT;8.73;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;15;-312.8342,62.44235;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;14;-768,64;Inherit;True;Property;_Multicolor;Multicolor;1;0;Create;True;0;0;0;False;0;False;-1;be3b8ddbbbf173646ae497e4d1a5f89a;be3b8ddbbbf173646ae497e4d1a5f89a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-272,-256;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-192,112;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-96,240;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-384,208;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-288,336;Inherit;False;Constant;_Float1;Float 0;1;0;Create;True;0;0;0;False;0;False;1.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-1184,-96;Inherit;False;Property;_Bias;Bias;2;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1200,0;Inherit;False;Property;_Scale;Scale;3;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1152,80;Inherit;False;Property;_Power;Power;4;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AC6298DDF46ED5F9041EAF09389044E0874F235D